...
bool EmArray(int ar[], int n, int q){
    ...
    for(i = 0;i < q; i++){
        ...
        if(n == ar[1] || n == ar[2] || n == ar[3] || n == ar[4] || n == ar[5]|| n == ar[6] || n == ar[7] || n == ar[8] || n == ar[9] || n == ar[10]){
...
bool EhArrayOrdenado(int ar[],int q){
...
int main(void){
    ...
    b = EhArrayOrdenado(ar,i);

    if(b == true){

        printf("Os elementos estao ordenados\n");
    }else{

        printf("Os elementos não estao ordenados\n");
    }
